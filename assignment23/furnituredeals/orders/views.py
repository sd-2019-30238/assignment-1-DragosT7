...
from furnituredeals.utils import ModifyFurnitureQuantityQuery, AddOrderRequest, RequestAllOrders, RequestSpecificOrder, RequestModifySpecificOrder, Mediator
